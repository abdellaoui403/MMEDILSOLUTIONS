...
const Hero = () => {
    return (
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-5 z-[5]`}>
...
{" "}
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-montserrat font-bold ss:text-[68px] text-[40px] text-[#353938] ss:leading-[75px] leading-[55px] ">
        ...
        <p className={`${styles.paragraph} ss:text-[22px] text-[18px] text-[#353938] max-w-[470px] mt-5`}>
